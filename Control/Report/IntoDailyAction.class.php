...
class IntoDailyAction extends CommonController {
	
	private $tepPrefix = 'into_daily_';
	...
	{	
		...
		if($date)
		{
			...
			for ($i=0;$i<24;$i++)
			{
				...
				$data += $this->getParkLogStat('into',$s_time,$e_time,$cardCategoryList,$carCategoryList);
				$list[] = $data;
			}
		}
